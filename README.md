...
| `game-design-document.md` | The authoritative Game Design Document (GDD) — defines the core loop, kick mechanics, target scoring with combo/streak multipliers, season/event-based level variants, cosmetic unlocks, and the free-play sandbox structure. The design "North Star" for all implementation decisions. |
